...
const footer = `
    <section class="d-flex flex-column gap-4">
        <section class="d-flex justify-content-center gap-4">
            ...
            <div>
                <a class="text-light icon-link icon-link-hover fs-1" style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);"  href="https://www.linkedin.com/in/camila-melissa-de-souza-a91413191" target="_blank" >
                    <i class="bi bi-linkedin"></i>
                </a>
            </div>
            <div>
                <a class="text-light icon-link icon-link-hover fs-1" style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);"  href="">
