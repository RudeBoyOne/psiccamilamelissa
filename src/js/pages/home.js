...
const homePage = `
    <section class="d-flex flex-column-reverse flex-lg-row align-items-center p-3">
        <section class="col-12 col-lg-6 pt-4 p-lg-4 d-flex flex-column justify-content-evenly text-section">
            <h1 class="fw-bold text-uppercase">  Atendimento clínico </h1>
            ...
            <h2 class="fw-bold fs-6 text-uppercase"> Por que escolher a psicanálise? </h2>
            <p class="text-justify lh-lg">
            ...
            <h2 class="fw-bold fs-6 text-uppercase"> Na minha clínica </h2>
            <p class="text-justify lh-lg">
            ...
            <h6 class="text-justify fw-bold text-uppercase">
